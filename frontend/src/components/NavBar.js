...
const NavBar = ({ className }) => {
    ...
    const handleLinkClick = (link) => {
        setActiveLink(link); // Cambia el enlace activo al que se hace clic
    };

    // Establece el enlace activo basado en la ruta actual
    useEffect(() => {
            ...
            <ul className="grid grid-cols-3 gap-4 sm:gap-0">
                <li className="flex justify-center items-center">
                    <Link
                        ...
                        className={`inline-flex flex-col items-center justify-center px-8 py-2 ${activeLink === '/' ? 'text-blue-600' : 'text-gray-300'} hover:bg-gray-50 dark:hover:bg-gray-800 group`}
                    >
                ...
                <li className="flex justify-center items-center">
                    <Link
                        ...
                        className={`inline-flex flex-col items-center justify-center px-8 py-2 ${activeLink === '/chat' ? 'text-blue-600' : 'text-gray-300'} hover:bg-gray-50 dark:hover:bg-gray-800 group`}
                    >
                ...
                <li className="flex justify-center items-center">
                    <Link
                        ...
                        className={`inline-flex flex-col items-center justify-center px-8 py-2 ${activeLink === '/bot' ? 'text-blue-600' : 'text-gray-300'} hover:bg-gray-50 dark:hover:bg-gray-800 group`}
                    >
